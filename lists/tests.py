...
class NewListTest(TestCase):
    ...
    def test_can_save_a_POST_request(self):
        self.client.post('/lists/new', data={'item_text': 'A new list item', 'ds_prioridade': 'A new Priority'})
    ...
    def test_redirects_after_POST(self):
        response = self.client.post('/lists/new',
                                    data={'item_text': 'A new list item', 'ds_prioridade': 'A new Priority'})
...
class NewItemTets(TestCase):
    def test_can_save_a_POST_request_to_an_existing_list(self):
        ...
        self.client.post(
            ...
            data={'item_text': 'A new item for an existing list', 'ds_prioridade':'A new priority for an existing list'}
        )
